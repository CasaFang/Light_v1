...
@implementation CPYMingLiBaZiTableViewCell
...
+ (instancetype)initFromNib{
    ...
    NSArray *arr = [[NSBundle mainBundle] loadNibNamed:@"CPYMingLiBaZiTableViewCell" owner:self options:nil];
    return arr[0];
}
