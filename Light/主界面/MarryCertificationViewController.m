...
@interface MarryCertificationViewController ()<MarryCertificationContentViewDelegate,UIActionSheetDelegate,MWPhotoBrowserDelegate>
{
...
- (void)viewDidLoad {
    ...
    [_marryPage getMarryDetailWithMarryId:user.marryPageId andCompletedBlock:^(BOOL isSuccess, LightMarryPage *marryPage, NSError *error) {
...
- (void)reloaMarryPagePics{
    ...
    LightUser *user = [LightMyShareManager shareUser].owner;
    [_marryPage getMarryPagePicksWithMarryId:user.marryPageId andCompletedBlock:^(BOOL isSuccess, NSArray *pics, NSError *error) {
