...
@implementation CPYCounselorTableViewCell
...
+ (instancetype)initFromNib{
    ...
    NSArray *arr = [[NSBundle mainBundle] loadNibNamed:@"CPYCounselorTableViewCell" owner:self options:nil];
    return arr[0];
}
