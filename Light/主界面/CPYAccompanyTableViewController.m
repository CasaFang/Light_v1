//
//  CPYAccompanyTableViewController.m
//  Light
//
...
#import "CPYAccompanyTableViewCell.h"
#import "LightMyShareManager.h"
#import "LightExperts.h"
#import "UIView+Hud.h"
#import <RongIMKit/RongIMKit.h>

@interface CPYAccompanyTableViewController ()

@property (strong , nonatomic) NSMutableArray *tableArray;

@end

static NSString *cellIdentifier = @"cpyaccompanycellidentifier";

@implementation CPYAccompanyTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.title = @"Light 陪伴师";
...
{
    CPYAccompanyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if (cell == nil) {
        
        cell = [CPYAccompanyTableViewCell initFromNib];
    }
