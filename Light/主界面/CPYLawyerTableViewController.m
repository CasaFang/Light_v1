//
//  CPYLawyerTableViewController.m
//  Light
//
...
#import "UIView+Hud.h"
#import "CPYLayerTableViewCell.h"
#import <RongIMKit/RongIMKit.h>

@interface CPYLawyerTableViewController ()

@property (strong , nonatomic) NSMutableArray *tableArray;

@end

static NSString *cellIdentifier = @"cpylawyercellidentifier";

@implementation CPYLawyerTableViewController
...
{
    CPYLayerTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if (cell == nil) {
        
        cell = [CPYLayerTableViewCell initFromNib];
    }
