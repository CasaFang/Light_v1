...
@implementation CPYMingLiTaLuoTableViewCell
...
+ (instancetype)initFromNib{
    ...
    NSArray *arr = [[NSBundle mainBundle] loadNibNamed:@"CPYMingLiTaLuoTableViewCell" owner:self options:nil];
    return arr[0];
}
