...
@implementation CPYAccompanyTableViewCell
...
+ (instancetype)initFromNib{
    ...
    NSArray *arr = [[NSBundle mainBundle] loadNibNamed:@"CPYAccompanyTableViewCell" owner:self options:nil];
    return arr[0];
}
